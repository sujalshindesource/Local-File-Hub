// match 1 perfect but prblm with phone ui 
...
//   return (
//     <div className="d-flex vh-100" style={{ backgroundColor: '#1a4d3a' }}>
//       {/* Sidebar */}
//       <div className="bg-dark text-white p-3" style={{ width: '250px', backgroundColor: '#0f2d1f !important' }}>
//         {/* Logo */}
...
//         {/* Content Area */}
//         <main className="flex-fill p-4" style={{ backgroundColor: '#1a4d3a' }}>
//           {/* Page Header */}
...
//match3 with again scrollbar and the duplicates are removed  
...
//                   Upload
//                 </button>
//                 <button className="btn btn-success" onClick={()=> handlefetchdrop()}>
//                   <Upload size={18} className="me-2" />
//                   {myfilefetch === true ? "Drop" : "Fetch"}
//                 </button>
//               </div>
//             </div>
